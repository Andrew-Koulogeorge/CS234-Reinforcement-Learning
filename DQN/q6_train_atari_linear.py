...
def eval():
    ...
    linear_model = Linear(env, config)
    
    state_dict = torch.load('/Users/andrewkoulogeorge/Desktop/RL/Problem Sets/PS2/results/q6_train_atari_linear/model.weights')

    print(type(state_dict))

    linear_model.q_network.load_state_dict(state_dict)
